...
(function () {
  ...
  const QUESTIONS = [
    ...
    },
    {
      ...
      year: "令和6年4月",
      question:
        "PPM（プロダクト・ポートフォリオ・マネジメント）において、「花形（スター）」に分類される事業の特徴として、最も適切なものはどれか。",
      choices: [
        "市場成長率が高く、相対的な市場シェアも高い。",
        "市場成長率が低く、相対的な市場シェアが高い。",
        "市場成長率が高く、相対的な市場シェアが低い。",
        "市場成長率が低く、相対的な市場シェアも低い。",
      ],
      answerIndex: 0,
      explanation:
        "PPMは市場成長率と相対的市場シェアの2軸で事業を「花形」「金のなる木」「問題児」「負け犬」に分類する。「花形（スター）」は両軸ともに高い事業であり、将来の主力候補として積極投資が必要とされる。「金のなる木」は成長率が低くシェアが高い、「問題児」は成長率が高くシェアが低い、「負け犬」は両方低いカテゴリである。",
    },
    {
      id: 21,
      category: "マネジメント",
      year: "令和3年4月",
      question:
        "プロジェクトマネジメントにおいて、プロジェクトのスコープ全体を管理可能な作業単位に階層的に分解した図を何というか。",
      choices: [
        "EVM（アーンドバリューマネジメント）",
        "WBS（ワーク・ブレークダウン・ストラクチャ）",
        "クリティカルパス",
        "ガントチャート",
      ],
      answerIndex: 1,
      explanation:
        "WBS（Work Breakdown Structure）は、プロジェクトの全成果物や作業を階層的に分解し、管理単位（ワークパッケージ）に整理した構成図である。スケジュール管理にはガントチャートやクリティカルパス、コスト・進捗の統合管理にはEVMが用いられる。",
    },
    {
      id: 22,
      category: "テクノロジ",
      ...
      choices: [
        "企業内の複数のサーバを仮想化技術で集約し、計算資源を効率的に共有する仕組み。",
        "複数の物理ディスクを束ねて冗長化・高速化を実現する記憶装置の構成技術。",
        "公衆回線上でデータを暗号化した仮想的な専用線を構築し、安全に通信する技術。",
        "内部ネットワークと外部ネットワークの境界でパケットを監視し、不正な通信を遮断する仕組み。",
      ],
      answerIndex: 2,
      explanation:
        "VPNはインターネットなどの公衆回線上にトンネリング・暗号化技術を用いて仮想的な専用回線を構築し、盗聴や改ざんを防ぎながら安全に通信する技術である。テレワークや拠点間接続に広く活用される。サーバ仮想化はサーバ統合技術、ディスク冗長化はRAID、境界でのパケット監視はファイアウォールの説明である。",
    },
  ];
