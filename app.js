...
(function () {
  ...
  const QUESTIONS = [
    ...
    },
    {
      ...
      year: "令和4年10月",
      question:
        "企業が一部の業務機能を外部の専門企業に委託し、内部資源をコア事業に集中させる戦略を何というか。",
      choices: [
        "アウトソーシング",
        "BPO",
        "コアコンピタンス戦略",
      ...
      answerIndex: 0,
      explanation:
        "アウトソーシングは、非コア業務を外部企業に委託することで、人材・資金・時間をコア事業に集中でき、競争力を高める戦略である。",
    },
    {
      id: 18,
      category: "マネジメント",
      year: "令和5年4月",
      question:
        "ソフトウェアの使用に関する権利と制限を定める契約文書を何というか。",
      choices: [
        "著作権登録書",
        "ソフトウェア保証書",
        "ソフトウェアライセンス",
      ...
      answerIndex: 2,
      explanation:
        "ソフトウェアライセンスは、著作権者がソフトウェアの使用条件（単一利用・複数利用、改変の可否、再配布の可否など）を定める契約。違反は著作権侵害となる。",
    },
    {
      id: 19,
      category: "テクノロジ",
      year: "令和3年10月",
      question:
        "メール送受信で用いられるプロトコルのうち、メールサーバからクライアントへメールを取得するために使われるものはどれか。",
      choices: [
        "HTTPS",
        "SMTP",
        "IMAP",
      ...
      answerIndex: 3,
      explanation:
        "POP3（Post Office Protocol 3）はメール受信プロトコルであり、メールサーバに格納されたメールをクライアント側にダウンロードする。SMTPは送信、IMAPは受信・管理機能が高い別プロトコルである。",
    },
  ];
