...
(function () {
  ...
  const QUESTIONS = [
    ...
    },
    {
      ...
      year: "令和5年4月",
      question:
        "リスク管理プロセスにおいて、想定される脅威に対して事前に対策を講じることを何というか。",
      choices: [
        "リスク受容",
        "リスク軽減",
        "リスク回避",
      ...
      answerIndex: 1,
      explanation:
        "リスク軽減は、想定される脅威の影響度や発生確率を低減させるため、事前対策を講じる手法である。リスク回避は活動そのものをやめ、リスク転嫁は保険などで責任を他者に移す。",
    },
    {
      id: 21,
      category: "ストラテジ",
      year: "令和6年4月",
      question:
        "デジタルマーケティングの手法として、顧客の行動履歴やニーズに基づいて個別にカスタマイズされた情報を提供することを何というか。",
      choices: [
        "マスマーケティング",
        "ダイレクトマーケティング",
        "パーソナライゼーション",
      ...
      answerIndex: 2,
      explanation:
        "パーソナライゼーションは、顧客ごとの嗜好や行動データを分析し、個別化された体験やコンテンツを提供するマーケティング手法である。",
    },
    {
      id: 22,
      category: "ストラテジ",
      year: "令和4年10月",
      question:
        "情報セキュリティポリシーの策定時に、最初に実施すべきプロセスはどれか。",
      choices: [
        "アクセス制御ルールの詳細な規定を決定する。",
        "情報資産の分類と、各カテゴリのリスク評価を行う。",
        "全従業員にセキュリティ教育を実施する。",
        "ファイアウォールや暗号化ツールを一括導入する。",
      ],
      answerIndex: 1,
      explanation:
        "セキュリティポリシー策定の基礎として、まずは情報資産を特定・分類し、脅威とリスクを評価することが重要である。その評価に基づいて対策を決定する。",
    },
    {
      id: 23,
      category: "マネジメント",
      year: "令和5年10月",
      question:
        "システム開発における要件定義フェーズで、最も重要な成果物はどれか。",
      choices: [
        "詳細設計書",
        "ソースコード",
        "要件仕様書",
      ...
      answerIndex: 2,
      explanation:
        "要件定義フェーズでは、顧客のニーズや要望を整理し、システムが満たすべき機能・非機能要件を明文化した要件仕様書を作成することが最も重要である。",
    },
    {
      id: 24,
      category: "マネジメント",
      year: "令和3年4月",
      question:
        "ソフトウェア開発の構成管理において、バージョン管理ツールの主な役割として、最も適切なものはどれか。",
      choices: [
        "不具合の重要度を判定し、修正優先順位を決定する。",
        "ソースコードの変更履歴を記録し、特定のバージョンの復元を可能にする。",
        "テストケースの実行結果を自動的に集計する。",
        "プロジェクトのスケジュールを管理し、進捗を可視化する。",
      ],
      answerIndex: 1,
      explanation:
        "バージョン管理ツールは、ソースコードの変更内容を記録・追跡し、過去のバージョンへの復元や複数開発者による並行開発を支援する重要なツールである。",
    },
    {
      id: 25,
      category: "マネジメント",
      year: "令和4年4月",
      question:
        "システムのリリース計画において、本番環境への反映前に実施するテスト環境での検証プロセスを何というか。",
      choices: [
        "ユニットテスト",
        "統合テスト",
        "本番テスト",
      ...
      answerIndex: 3,
      explanation:
        "ステージングテストは、本番環境と同等の構成を持つ検証環境で、本番環境への切替前に機能・パフォーマンス・安定性などを確認するプロセスである。",
    },
    {
      id: 26,
      category: "マネジメント",
      year: "令和6年10月",
      question:
        "組織横断的なプロジェクトにおいて、複数の部門の利害関係者間で合意を形成するために最初に実施すべきことはどれか。",
      choices: [
        "ステアリングコミッティを設置し、役割と意思決定フローを明確にする。",
        "プロジェクト計画書を完成させ、全員に配布する。",
        "技術的な詳細設計を決定する。",
        "本番導入スケジュールを立案する。",
      ],
      answerIndex: 0,
      explanation:
        "複数の部門が関わるプロジェクトでは、ステアリングコミッティを設置し、意思決定権者と役割を明確化し、利害関係者間の調整メカニズムを構築することが重要である。",
    },
    {
      id: 27,
      category: "テクノロジ",
      year: "令和5年4月",
      question:
        "ネットワークセキュリティにおいて、外部からの不正アクセスや攻撃を検知・防止するシステムを何というか。",
      choices: [
        "プロキシサーバ",
        "IDSおよびIPS",
        "ロードバランサ",
      ...
      answerIndex: 1,
      explanation:
        "IDS（侵入検知システム）は不正アクセスを検知し、IPS（侵入防止システム）は検知した後に通信をブロックして攻撃を防止する。両者を組み合わせてネットワークを保護する。",
    },
    {
      id: 28,
      category: "テクノロジ",
      year: "令和3年10月",
      question:
        "メモリ管理において、プログラムが確保したメモリを解放せずに残すことによる問題を何というか。",
      choices: [
        "バッファオーバーフロー",
        "メモリリーク",
        "デッドロック",
      ...
      answerIndex: 1,
      explanation:
        "メモリリークは、不要になったメモリを解放しないまま放置することで、利用可能なメモリが減少し、最終的にシステムのパフォーマンス低下や停止を招く問題である。",
    },
    {
      id: 29,
      category: "テクノロジ",
      year: "令和6年4月",
      question:
        "大規模データセットを効率的に検索するアルゴリズムとして、計算量がO(log n)であるアルゴリズムはどれか。",
      choices: [
        "線形探索",
        "バブルソート",
        "二分探索",
      ...
      answerIndex: 2,
      explanation:
        "二分探索はソート済みデータに対して中央値と比較することで、毎回探索範囲を半減させ、計算量がO(log n)となる効率的なアルゴリズムである。",
    },
  ];
