...
(function () {
  ...
  const QUESTIONS = [
    ...
    },
    {
      ...
      year: "令和6年10月",
      question:
        "事業戦略において、対象顧客や提供する製品・サービスを限定し、特定の市場に経営資源を集中させる戦略を何というか。",
      choices: [
        "集中戦略",
        "多角化戦略",
        "分散戦略",
      ...
      answerIndex: 0,
      explanation:
        "集中戦略（ニッチ戦略）は、特定の市場セグメントに選択と集中を行い、限られた経営資源を効果的に活用する戦略である。",
    },
    {
      id: 18,
      category: "マネジメント",
      year: "令和5年4月",
      question:
        "ソフトウェア開発における品質保証（QA）の役割として、最も適切なものはどれか。",
      choices: [
        "開発過程で発生したバグを修正し、出荷前に必ず全て排除する。",
        "顧客への納期遵守と、製品機能の全数確認を行う。",
        "要件定義から本番運用まで、全工程において品質基準を満たしているかを確認・評価する。",
        "テスト計画書を作成し、テスト実行者に指示を与えて実行効率を高める。",
      ],
      answerIndex: 2,
      explanation:
        "品質保証（QA: Quality Assurance）は、製品やサービスが定義された品質基準を満たしているかを全プロセスで確認する活動である。単なる障害検出ではなく、予防的な品質管理を実現する。",
    },
    {
      id: 19,
      category: "テクノロジ",
      year: "令和4年10月",
      question:
        "ネットワークセキュリティにおいて、ファイアウォールと同様に外部からの不正アクセスを防ぐため、パケットの内容を検査・遮断する機器を何というか。",
      choices: [
        "DMZ",
        "VPN",
        "IDS",
      ...
      answerIndex: 3,
      explanation:
        "IPS（Intrusion Prevention System）は、不正なパケットを検知するだけでなく、それをブロック・遮断する機能を持つセキュリティ機器である。IDSは検知のみで遮断は行わない。",
    },
  ];
