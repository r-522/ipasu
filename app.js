...
(function () {
  ...
  const QUESTIONS = [
    ...
    },
    {
      ...
      choices: [
        "既存システムから最新のハードウェアへの物理的な置き換えプロセスである。",
        "コンピュータやデータを活用して、ビジネスプロセスや組織文化を抜本的に変革し、競争力を強化する取組である。",
        "クラウドサービスの導入だけに焦点を当てた技術更新プロジェクトである。",
        "紙の書類をすべてスキャンして電子化する業務改善活動である。",
      ],
      answerIndex: 1,
      explanation:
        "DXは単なるIT導入ではなく、デジタル技術を活用してビジネスモデル・プロセス・文化を変え、顧客価値を創造し競争力を高める総合的な取組である。",
    },
    {
      id: 43,
      category: "マネジメント",
      year: "令和5年10月",
      question:
        "プロジェクト管理におけるスコープとして、最も適切な説明はどれか。",
      choices: [
        "プロジェクトの予算額と資金調達方法の計画である。",
        "プロジェクトで実施する作業の範囲と成果物の定義である。",
        "プロジェクト団員の勤務時間と残業時間の管理方法である。",
        "プロジェクトメンバーの技能レベルと経験年数の評価基準である。",
      ],
      answerIndex: 1,
      explanation:
        "スコープはプロジェクトが何を実現するか、どの機能・納品物を含めるか、どの範囲までを対象とするかを明確に定義するもので、プロジェクト成功の基本である。",
    },
    {
      id: 44,
      category: "テクノロジ",
      year: "令和6年4月",
      question:
        "HTTPS通信で使用されるSSL/TLSプロトコルの主な役割として、最も適切なものはどれか。",
      choices: [
        "ネットワークパケットの遅延時間を最小化し、通信速度を向上させる。",
        "サーバとクライアント間の通信を暗号化し、データの機密性を保証する。",
        "ファイアウォールを経由する通信を自動的にブロックする。",
        "複数のクライアントからの同時接続を拒否し、セッションハイジャックを防止する。",
      ],
      answerIndex: 1,
      explanation:
        "SSL/TLSは通信を暗号化するプロトコルで、中間者による盗聴・改ざんを防ぎ、Webサイトのセキュリティを確保する。",
    },
    {
      id: 45,
      category: "マネジメント",
      year: "令和3年10月",
      question:
        "情報セキュリティのリスク評価プロセスとして、最初に実施すべきことはどれか。",
      choices: [
        "セキュリティ対策の予算を決定する。",
        "保有する資産を特定し、脅威と脆弱性を識別する。",
        "すべての従業員にセキュリティ教育を実施する。",
        "外部の監査機関に評価を依頼する。",
      ],
      answerIndex: 1,
      explanation:
        "リスク評価は、組織が保有するIT資産・情報資産を把握し、それらに対する脅威と脆弱性を識別したうえで、リスクレベルを判定することから始まる。",
    },
    {
      id: 46,
      category: "ストラテジ",
      year: "令和4年4月",
      question:
        "事業継続計画（BCP）の目的として、最も適切なものはどれか。",
      choices: [
        "企業の利益を最大化し、株主の配当を増やすことである。",
        "自然災害や大規模障害時に、重要業務の継続と迅速な復旧を実現することである。",
        "新規事業を開発し、企業の営業範囲を拡大することである。",
        "競合企業との価格競争に勝つためのコスト削減計画である。",
      ],
      answerIndex: 1,
      explanation:
        "BCPは予想される災害や事象に備え、重要な業務機能を維持・復旧させるための事前計画で、企業の持続性を確保する。",
    },
    {
      id: 47,
      category: "テクノロジ",
      year: "令和5年10月",
      question:
        "IoT（Internet of Things）の特徴として、最も適切なものはどれか。",
      choices: [
        "コンピュータとプリンタをローカルネットワークで接続する技術である。",
        "身の回りのセンサーやデバイスをインターネットで接続し、データを収集・分析する。",
        "クラウド上のデータベースのみにアクセスする専用ネットワークプロトコルである。",
        "スマートフォンの電池消費を減らすための省電力機能である。",
      ],
      answerIndex: 1,
      explanation:
        "IoTは様々なセンサー・デバイスをインターネットに接続し、リアルタイムデータを収集・分析して、スマートな制御・最適化を実現する技術である。",
    },
    {
      id: 48,
      category: "マネジメント",
      year: "令和3年4月",
      question:
        "品質管理（QC）の基本的な活動として、最も適切なものはどれか。",
      choices: [
        "製品の価格設定を市場相場に合わせることである。",
        "測定・検査を通じて製品・サービスの品質水準を維持・向上させることである。",
        "営業戦略を立案し、販売数量を増やすことである。",
        "新聞やメディアで企業の広告を掲載することである。",
      ],
      answerIndex: 1,
      explanation:
        "品質管理は製造・提供の過程で製品・サービスを測定・検査し、顧客満足度を確保するための管理活動である。",
    },
    {
      id: 49,
      category: "ストラテジ",
      year: "令和6年10月",
      question:
        "特許制度の説明として、最も適切なものはどれか。",
      choices: [
        "商品やサービスの名前や標章の使用権を保護する仕組みである。",
        "発明や技術を一定期間独占的に利用できる権利を付与する仕組みである。",
        "著作物の複製権や公表権を自動的に保護する仕組みである。",
        "営業秘密の内容が漏洩した場合の損害賠償請求権である。",
      ],
      answerIndex: 1,
      explanation:
        "特許権は、発明を行った者に一定期間（日本では最長20年）その発明を独占的に実施できる権利を付与し、技術開発の促進を図る制度である。",
    },
    {
      id: 50,
      category: "テクノロジ",
      year: "令和4年10月",
      question:
        "クラウドコンピューティングのサービス形態の説明として、最も適切なものはどれか。",
      choices: [
        "SaaS / IaaS / PaaSは、提供する機能の範囲が異なるサービス形態である。",
        "すべてのクラウドサービスはメインフレームコンピュータで実行される。",
        "クラウドサービスを利用するには、高度なプログラミング知識が必須である。",
        "SaaS、IaaS、PaaSは機能が同じで、ベンダーによる呼び方の違いに過ぎない。",
      ],
      answerIndex: 0,
      explanation:
        "クラウドサービスは、SaaS（ソフトウェア全体を提供）、IaaS（インフラを提供）、PaaS（開発環境を提供）の3つの形態があり、各々が提供する範囲が異なる。",
    },
    {
      id: 51,
      category: "マネジメント",
      ...
      choices: [
        "業務プロセスの変更にともなう混乱や抵抗を最小化し、円滑に導入する。",
        "顧客からの苦情をすべて受け入れて対応することである。",
        "社員の給与体系を年1回定期的に改定することである。",
        "組織の経営層を定期的に入れ替えることである。",
      ],
      answerIndex: 0,
      explanation:
        "チェンジマネジメントは、システムやプロセスの変更時に、従業員の心理的抵抗を減らし、スムーズに新しい業務方式に移行するための管理活動である。",
    },
  ];
