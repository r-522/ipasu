...
(function () {
  ...
  const QUESTIONS = [
    ...
    },
    {
      ...
      year: "令和5年10月",
      question:
        "ビジネスモデルキャンバスを用いて事業計画を立案する際の目的として、最も適切なものはどれか。",
      choices: [
        "事業の価値提案から収益源まで、複数の要素を統合的に可視化し、事業全体の構造を把握する。",
        "財務報告書の数値に基づいて、過去の売上実績をグラフ化する。",
        "商品の製造工程や品質管理の詳細フローを図解する。",
        "従業員の職務経歴書と人事評価記録をマトリックス形式で整理する。",
      ],
      answerIndex: 0,
      explanation:
        "ビジネスモデルキャンバスは、顧客セグメント・価値提案・チャネル・収益源等9つの要素を1枚の図で統合的に整理し、事業モデル全体を可視化する手法である。",
    },
    {
      id: 31,
      category: "マネジメント",
      year: "令和4年4月",
      question:
        "プロジェクトの範囲を定義する際に作成する、納品物と作業を階層的に分類するドキュメントを何というか。",
      choices: [
      ...
      answerIndex: 0,
      explanation:
        "WBS（Work Breakdown Structure）は、プロジェクトの全体的な成果物と作業を階層的に分割し、詳細な計画・管理・追跡の基礎となるドキュメントである。",
    },
    {
      id: 32,
      category: "テクノロジ",
      year: "令和5年4月",
      question:
        "データベーストランザクションのACID特性における、複数のトランザクションが同時実行される場合の分離の程度を何というか。",
      choices: [
        "原子性（Atomicity）",
        "一貫性（Consistency）",
        "分離性（Isolation）",
      ...
      answerIndex: 2,
      explanation:
        "分離性（Isolation）は、複数のトランザクションが同時実行される場合、相互に干渉しない独立性を保証する特性。ロック機構で実装される。",
    },
    {
      id: 33,
      category: "ストラテジ",
      year: "令和6年4月",
      question:
        "供給チェーン全体の最適化を目指す企業間の協業形態を、何というか。",
      choices: [
      ...
      answerIndex: 0,
      explanation:
        "SCM（Supply Chain Management）は、調達・製造・流通・販売に携わる複数企業間で情報・物資を統合的に管理し、コスト削減と効率化を実現する取組みである。",
    },
    {
      id: 34,
      category: "マネジメント",
      year: "令和5年10月",
      question:
        "ソフトウェア開発プロセスモデルにおいて、前の工程が完全に終了してから次の工程に進む方式を何というか。",
      choices: [
        "ウォーターフォール型",
        "スパイラル型",
        "イテレーティブ型",
      ...
      answerIndex: 0,
      explanation:
        "ウォーターフォール型は、要件定義→設計→実装→テスト→本番運用と、各工程を順序通りに進める古典的な開発方式である。",
    },
    {
      id: 35,
      category: "テクノロジ",
      ...
      choices: [
        "大容量のデータを長期保存し、電源が切れてもデータが失われない。",
        "CPUとメインメモリ間の速度差を補い、データアクセス速度を高速化する。",
        "ネットワーク上の遠隔サーバからデータをダウンロードする際の一時保管場所。",
        "複数のプログラムを同時に実行する場合、メモリ領域を動的に割り当てる。",
      ],
      answerIndex: 1,
      explanation:
        "キャッシュメモリはCPUとメインメモリの間に配置され、頻繁にアクセスされるデータを高速に供給することで、システム全体の性能向上を図る。",
    },
    {
      id: 36,
      category: "ストラテジ",
      year: "令和4年10月",
      question:
        "製品ポートフォリオマネジメント（PPM）で用いるマトリクスにおいて、市場成長率が低く相対的市場シェアが高い製品カテゴリを何というか。",
      choices: [
        "問題児",
        "花形製品",
        "金のなる木",
      ...
      answerIndex: 2,
      explanation:
        "PPMマトリクスにおいて、市場成長率低・相対市場シェア高の象限は「金のなる木」と呼ばれ、安定収益源として現金を生み出す製品を表す。",
    },
    {
      id: 37,
      category: "マネジメント",
      year: "令和6年10月",
      question:
        "サービス提供機関の従業員が顧客と直接接する場面における品質を、何というか。",
      choices: [
        "内部品質",
        "設計品質",
        "モーメント・オブ・トゥルース",
      ...
      answerIndex: 2,
      explanation:
        "モーメント・オブ・トゥルース（真実の瞬間）は、顧客がサービスを体験する瞬間であり、この際の従業員の対応がサービス品質を決定する重要な接点である。",
    },
    {
      id: 38,
      category: "テクノロジ",
      year: "令和5年4月",
      question:
        "XMLの説明として、最も適切なものはどれか。",
      choices: [
        "プログラミング言語であり、Webブラウザ上で実行されるスクリプト。",
        "データの意味を記述できるマークアップ言語であり、異なるシステム間のデータ交換に用いられる。",
        "リレーショナルデータベースを操作するためのスクリプト言語。",
        "Webサーバとクライアント間で画像や動画を配信するためのプロトコル。",
      ],
      answerIndex: 1,
      explanation:
        "XML（eXtensible Markup Language）はタグでデータの意味を記述できるマークアップ言語であり、異なるプログラムやシステム間のデータ交換に広く用いられる。",
    },
    {
      id: 39,
      category: "ストラテジ",
      year: "令和3年4月",
      question:
        "企業のパーパス（Purpose）の説明として、最も適切なものはどれか。",
      choices: [
        "短期的な利益最大化のための施策。",
        "企業が社会に対して果たすべき根本的な使命や存在意義。",
        "商品やサービスの価格を決定するプロセス。",
        "競合他社との市場シェア争いの戦略。",
      ],
      answerIndex: 1,
      explanation:
        "パーパスは企業の根本的な使命や存在意義を示し、単なる利益追求を超えて、社会への貢献や長期的な価値創造の方向性を示すものである。",
    },
    {
      id: 40,
      category: "マネジメント",
      year: "令和4年10月",
      question:
        "要件定義フェーズで客先と合意する、利用者の期待を満たすために達成すべき事項を何というか。",
      choices: [
        "ユースケース",
        "受け入れ基準",
        "システム要件",
      ...
      answerIndex: 1,
      explanation:
        "受け入れ基準は、納入されたシステムが利用者の期待と要件を満たしているかを検証するための具体的な条件である。",
    },
    {
      id: 41,
      category: "テクノロジ",
      year: "令和5年10月",
      question:
        "コンテナ技術（Docker等）の利点として、最も適切なものはどれか。",
      choices: [
        "開発環境と本番環境の差異を排除し、どの環境でも同じように動作するアプリケーション実行を実現する。",
        "物理的なサーバのハードウェアスペックに完全に依存し、自動スケーリングが可能である。",
        "従来のOS起動より時間がかかるため、リアルタイムシステムに向いている。",
        "ソースコードのコンパイルが不要になり、全言語で対応できる。",
      ],
      answerIndex: 0,
      explanation:
        "コンテナ技術は、アプリケーションとその実行環境を統合して軽量なコンテナイメージとして固定し、環境依存性を最小化して可搬性と一貫性を高める。",
    },
    {
      id: 42,
      category: "ストラテジ",
      year: "令和6年4月",
      question:
        "顧客ジャーニーマップを作成する目的として、最も適切なものはどれか。",
      choices: [
        "顧客が製品購入から使用・廃棄まで経験する全過程とタッチポイントを可視化し、改善機会を発見する。",
        "サプライチェーン上での原材料の移動を追跡し、物流効率を測定する。",
        "従業員のキャリアパスと研修スケジュールを一覧で示す。",
        "予算配分の意思決定プロセスを記録し、監査の証跡とする。",
      ],
      answerIndex: 0,
      explanation:
        "顧客ジャーニーマップは、顧客の購買プロセスや利用体験の全段階を時系列で図解し、接触点やペイン・ゲイン・感情を分析して、改善の焦点を発見する手法である。",
    },
    {
      id: 43,
      category: "マネジメント",
      year: "令和3年10月",
      question:
        "ソフトウェア品質の設計段階での定義について、最も適切なものはどれか。",
      choices: [
        "仕様書を詳細に作成し、実装時のバグリスクを低減する品質設計。",
        "テストケースの網羅率を高めることで、品質を保証する。",
        "クライアント側でのフィードバックを元に、反復的にシステムの質を向上させる。",
        "使用者のニーズ抽出から始まり、信頼性・保守性・拡張性等の非機能要件を明確化して設計に組み込む。",
      ],
      answerIndex: 3,
      explanation:
        "品質の設計段階での定義は、要件分析段階で信頼性・保守性・セキュリティ等の非機能特性を明確にし、それを設計・実装に組み込むことで、本質的品質を確保する。",
    },
    {
      id: 44,
      category: "テクノロジ",
      year: "令和4年4月",
      question:
        "機械学習における過学習（オーバーフィッティング）の説明として、最も適切なものはどれか。",
      choices: [
        "学習データに特有なノイズやばらつきまで学習してしまい、新しいデータに対する予測精度が低下する現象。",
        "学習に用いるデータ量が少なすぎるため、モデルが十分に学習できず、汎化性能が低い状態。",
        "複数のモデルを組み合わせ、予測精度をさらに高める手法。",
        "学習データと検証データの分布が異なることで生じる、予測の不安定性。",
      ],
      answerIndex: 0,
      explanation:
        "過学習は、訓練データの偶発的なばらつきやノイズまで含めて学習してしまい、未知のテストデータに対する性能が低下する現象。正則化やクロスバリデーションで対策される。",
    },
  ];
