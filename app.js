...
(function () {
  ...
  const QUESTIONS = [
    ...
    },
    {
      ...
      year: "令和5年10月",
      question:
        "企業の経営戦略において、強力な競争優位を構築するための要因として、最も適切なものはどれか。",
      choices: [
        "価格を競合他社と同一に設定する。",
        "独自の技術・ブランド・顧客基盤などのコア・コンピタンスを活かす。",
        "すべての市場セグメントに均等に対応する。",
        "新規事業への投資を最小限に抑える。",
      ],
      answerIndex: 1,
      explanation:
        "競争優位は、他社では容易に模倣できない自社の独特な資源や能力に基づいており、その強みを徹底的に活かすことが重要である。",
    },
    {
      id: 58,
      category: "ストラテジ",
      year: "令和4年10月",
      question:
        "経営効率を改善するための KPI（Key Performance Indicator）の設定において、最も重要な特性は何か。",
      choices: [
        "複雑で理解しにくい指標を多数用いる。",
        "定量的で測定可能であり、企業戦略に直結した指標を設定する。",
        "過去の実績を無視して、恣意的に目標値を決定する。",
        "部門ごとに全く異なる指標を設定する。",
      ],
      answerIndex: 1,
      explanation:
        "KPIは戦略実現に向けた進捗を測定する指標であり、定量的で測定可能、また事業戦略と一貫性が必要である。",
    },
    {
      id: 59,
      category: "ストラテジ",
      year: "令和6年10月",
      question:
        "持続可能な経営（サステナビリティ）を実現するための取り組みとして、最も適切なものはどれか。",
      choices: [
        "利益最大化のためなら環境破壊や社会問題を無視する。",
        "経済・環境・社会の三側面のバランスを取った経営を実践する。",
        "短期的な利益のみを追求し、長期的課題は先延ばしにする。",
        "企業が社会的責任を負う必要はない。",
      ],
      answerIndex: 1,
      explanation:
        "サステナビリティは経済成長と環境保全、社会的責任のバランスを実現し、長期的な企業価値を高める経営アプローチである。",
    },
    {
      id: 60,
      category: "ストラテジ",
      year: "令和5年4月",
      question:
        "プロダクトライフサイクル（PLC）の導入期・成長期・成熟期・衰退期各段階で、最も適切なマーケティング戦略の組合せはどれか。",
      choices: [
        "導入期は販売促進、成長期は拡大、成熟期は防御、衰退期は撤退を基本とする。",
        "全期間を通じて同じ戦略を繰り返す。",
        "成長期のみに注力し、導入期と衰退期は軽視する。",
        "消費者の需要と関係なく計画する。",
      ],
      answerIndex: 0,
      explanation:
        "PLCの各段階は市場特性が異なるため、導入期は認知向上、成長期は市場拡大、成熟期は競争対応、衰退期は段階的撤退という段階的戦略が効果的である。",
    },
    {
      id: 61,
      category: "マネジメント",
      year: "令和4年4月",
      question:
        "プロジェクトマネジメントにおいて、発生確率が高く影響も大きいリスクに対する対応戦略として、最も適切なものはどれか。",
      choices: [
        "リスクを完全に受け入れ、何もしない。",
        "リスク対応計画を策定し、積極的に軽減措置を実施する。",
        "リスクの存在を隠す。",
        "リスクが顕在化するまで待つ。",
      ],
      answerIndex: 1,
      explanation:
        "高い発生確率と影響度を持つリスクは対応優先度が最も高く、事前に軽減策や対応計画を検討し、実行することが重要である。",
    },
    {
      id: 62,
      category: "マネジメント",
      year: "令和5年10月",
      question:
        "ステークホルダー分析において、組織にとって重要度が高く、かつ影響力が大きいステークホルダーの管理方針として、最も適切なものはどれか。",
      choices: [
        "関心を示さず、定期的な報告も行わない。",
        "積極的に関わり、密接に協働し、満足度を継続的に監視する。",
        "最小限の対応のみとする。",
        "意見を聞かずに一方的に進める。",
      ],
      answerIndex: 1,
      explanation:
        "重要度と影響力が高いステークホルダーは「Manage Closely」（積極的に管理）が必要であり、頻繁なコミュニケーションと協働が重須である。",
    },
    {
      id: 63,
      category: "マネジメント",
      year: "令和6年4月",
      question:
        "組織文化の醸成と強化を目的とした施策として、最も適切なものはどれか。",
      choices: [
        "経営層と一般社員の間に厳密な階級制度のみを設ける。",
        "経営理念を明確にし、全従業員による共有を促進し、組織内の価値観を一貫させる。",
        "文化や価値観は個人に任せ、組織として関与しない。",
        "新しい人材を採用するたびに組織文化を全て変更する。",
      ],
      answerIndex: 1,
      explanation:
        "組織文化は経営理念の実現を支える基盤であり、経営層が理念を明確に示し、全従業員が共有することで強化される。",
    },
    {
      id: 64,
      category: "テクノロジ",
      ...
      choices: [
        "すべての処理をクラウドデータセンターで集約実行する。",
        "データ生成地点に近いネットワークエッジで処理し、遅延を削減し、プライバシーを保護できる。",
        "インターネット接続がなくても機能する必須要件である。",
        "クラウドコンピューティングと全く異なり、置き換わる技術である。",
      ],
      answerIndex: 1,
      explanation:
        "エッジコンピューティングはデータ発生地点（センサ、IoTデバイス）の近くで処理することで、遅延の削減、プライバシー保護、リアルタイム性向上を実現する。",
    },
    {
      id: 65,
      category: "テクノロジ",
      year: "令和4年10月",
      question:
        "シンクライアントの利点として、最も適切なものはどれか。",
      choices: [
        "端末に高い処理能力が必要になり、コストが増加する。",
        "キーボードやマウスなどの周辺機器のみで、処理はサーバ側で集中実行されるため、端末管理が容易で安全である。",
        "インターネット接続が不要で、完全にスタンドアロンで運用できる。",
        "端末ごとにOSやアプリをインストールし、保守が簡単になる。",
      ],
      answerIndex: 1,
      explanation:
        "シンクライアントは処理をサーバで行い、端末には入出力機能のみを持たせるため、管理が一元化でき、セキュリティも向上する。",
    },
    {
      id: 66,
      category: "テクノロジ",
      year: "令和6年10月",
      question:
        "サイバーセキュリティの多層防御（Defense in Depth）の概念として、最も適切なものはどれか。",
      choices: [
        "単一の強力なファイアウォール1つで全ての脅威に対応できる。",
        "複数のセキュリティ対策層を組み合わせることで、1つの防御が破られても他が機能する堅牢な防御を実現する。",
        "セキュリティは古い概念であり、最新技術導入は不要である。",
        "攻撃に対応するのではなく、すべての端末をインターネットから遮断する。",
      ],
      answerIndex: 1,
      explanation:
        "多層防御は複数のセキュリティ措置（ファイアウォール、IDS/IPS、エンドポイント保護、暗号化など）を組み合わせ、いずれかが侵害されても全体が保護される仕組みである。",
    },
  ];
