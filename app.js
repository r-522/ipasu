...
(function () {
  ...
  const QUESTIONS = [
    ...
    },
    {
      ...
      year: "令和5年4月",
      question:
        "企業の長期的な競争優位を確保するために、必要な資源・能力・特性を何というか。",
      choices: [
        "コア・コンピタンス",
        "バリューチェーン",
        "アウトソーシング",
      ...
      answerIndex: 0,
      explanation:
        "コア・コンピタンスは、企業が競争相手を圧倒する独自の強み・能力を意味し、経営戦略の基盤となる。",
    },
    {
      id: 31,
      category: "マネジメント",
      year: "令和4年10月",
      question:
        "ソフトウェア開発プロジェクトの進捗を可視化するために用いられる、作業を段階別に横軸に配置したグラフを何というか。",
      choices: [
        "ネットワーク図",
        "ガントチャート",
        "PERT図",
      ...
      answerIndex: 1,
      explanation:
        "ガントチャートは、タスクの開始・終了日程を時系列で表示し、プロジェクト全体の進捗状況を管理するための図表である。",
    },
    {
      id: 32,
      category: "テクノロジ",
      year: "令和3年4月",
      question:
        "HTTPSにおいて、通信の暗号化と相手先の認証を実現するプロトコルはどれか。",
      choices: [
        "SSL/TLS",
        "SSH",
        "IPsec",
      ...
      answerIndex: 0,
      explanation:
        "SSL/TLSはウェブブラウザとサーバ間の通信を暗号化し、デジタル証明書によってサーバの真正性を認証するセキュアプロトコルである。",
    },
    {
      id: 33,
      category: "ストラテジ",
      year: "令和6年4月",
      question:
        "情報システム投資の意思決定に用いる、投資回収期間や投資利益率を算出する手法として最も適切なものはどれか。",
      choices: [
        "ROI分析",
        "感度分析",
        "シミュレーション分析",
      ...
      answerIndex: 0,
      explanation:
        "ROI（Return On Investment）分析は、投資に対する収益性を定量的に評価し、意思決定を支援する財務分析手法である。",
    },
    {
      id: 34,
      category: "マネジメント",
      year: "令和5年4月",
      question:
        "要件定義段階で、利用者の具体的なニーズや期待を詳細に把握するための手法として最も適切なものはどれか。",
      choices: [
        "ユーザインタビュー",
        "ユニットテスト",
        "コードレビュー",
      ...
      answerIndex: 0,
      explanation:
        "ユーザインタビューは、利用者と対話して業務要件・課題・期待を詳細に引き出し、要件定義の精度を高める重要なプロセスである。",
    },
    {
      id: 35,
      category: "テクノロジ",
      year: "令和4年4月",
      question:
        "ウェブアプリケーションの脆弱性として、利用者の入力値をサニタイズしないまま使用した場合に発生する攻撃を何というか。",
      choices: [
        "バッファオーバーフロー",
        "インジェクション攻撃",
        "DDoS攻撃",
      ...
      answerIndex: 1,
      explanation:
        "インジェクション攻撃は、利用者の入力値に悪意あるコードを埋め込み、データベースやOSに対して不正なコマンドを実行させる攻撃である。",
    },
    {
      id: 36,
      category: "ストラテジ",
      year: "令和3年10月",
      question:
        "知的財産権の保護において、独自に開発した製造方法を秘密にして保護する場合の法律上の概念を何というか。",
      choices: [
        "営業秘密",
        "著作権",
        "意匠権",
      ...
      answerIndex: 0,
      explanation:
        "営業秘密は、秘密として管理されていることが価値を持つ情報を法律で保護する制度であり、特許と異なり出願不要である。",
    },
    {
      id: 37,
      category: "マネジメント",
      year: "令和6年10月",
      question:
        "プロジェクトマネジメントにおいて、スコープの範囲外となる追加要求に対応するプロセスを何というか。",
      choices: [
        "スコープクリープ管理",
        "チェンジコントロール",
        "リスク対応",
      ...
      answerIndex: 1,
      explanation:
        "チェンジコントロール（変更管理）は、予期しない変更要求を評価し、スコープや予算・スケジュールへの影響を判断して対応するプロセスである。",
    },
    {
      id: 38,
      category: "テクノロジ",
      year: "令和5年10月",
      question:
        "システム監視において、CPU使用率やメモリ使用量などの性能指標を常時収集し、異常を自動検知する技術を何というか。",
      choices: [
        "ロードバランシング",
        "キャパシティプランニング",
        "ヘルスチェック",
      ...
      answerIndex: 2,
      explanation:
        "ヘルスチェックは、サーバやアプリケーションの稼働状況を継続的に監視し、異常を迅速に検知・通知するメカニズムである。",
    },
    {
      id: 39,
      category: "テクノロジ",
      year: "令和4年10月",
      question:
        "コンテナ技術（Docker等）の主な利点として、最も適切なものはどれか。",
      choices: [
        "アプリケーションと依存ライブラリを軽量なイメージで一括管理でき、環境の差異による問題を排除できる。",
        "仮想マシンより高いセキュリティ隔離が実現され、マルウェア感染のリスクがなくなる。",
        "ネットワーク遅延がなくなり、通信速度が物理的に無制限となる。",
        "複数のデータベースを自動で同期し、データの二重化が不要になる。",
      ],
      answerIndex: 0,
      explanation:
        "コンテナは、アプリケーション・ライブラリ・設定を1つのイメージにまとめるため、開発環境と本番環境の差異を最小化でき、デプロイを高速化できる。",
    },
  ];
