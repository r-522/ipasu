...
(function () {
  ...
  const QUESTIONS = [
    ...
    },
    {
      ...
      year: "令和5年4月",
      question:
        "企業の競争優位性を高めるために、市場・顧客・技術などの外部環境を分析する手法として、最も適切なものはどれか。",
      choices: [
        "SWOT分析",
        "カンバン方式",
        "ベストプラクティス",
      ...
      answerIndex: 0,
      explanation:
        "SWOT分析は、企業の強み（Strength）、弱み（Weakness）、機会（Opportunity）、脅威（Threat）を分析し、経営戦略の立案に活用される手法である。",
    },
    {
      id: 31,
      category: "マネジメント",
      year: "令和6年4月",
      question:
        "プロジェクト管理において、スケジュール遅延のリスクを事前に検出する方法として、最も適切なものはどれか。",
      choices: [
        "プロジェクト完了後に予算の監査を実施する。",
        "各タスクの進捗を定期的に監視し、計画との差分を把握する。",
        "すべてのタスクを同時に並行実行する。",
        "リスク顕在化後に対応計画を立案する。",
      ],
      answerIndex: 1,
      explanation:
        "進捗管理は、実績と計画を定期的に比較することで、遅延や偏差を早期に検出し、必要な是正措置を取るためのプロジェクト管理の重要な機能である。",
    },
    {
      id: 32,
      category: "テクノロジ",
      ...
      choices: [
        "初期投資が大きいため、企業の経営効率が向上する。",
        "ハードウェア購入・管理の手間を削減でき、IT運用コストを低下させられる。",
        "すべてのデータが企業の社内システムに保管されるため、セキュリティが最大化される。",
        "利用者数の増加に応じて、システム性能は自動的に低下する。",
      ],
      answerIndex: 1,
      explanation:
        "クラウドコンピューティングは、ハードウェア・ソフトウェアをクラウドプロバイダが管理し、企業は必要な機能を利用可能な状況下でのみ支払うため、運用コストの最適化が実現される。",
    },
    {
      id: 33,
      category: "ストラテジ",
      year: "令和4年4月",
      question:
        "消費者のニーズを製品やサービスに反映させるプロセスとして、最も適切なものはどれか。",
      choices: [
        "市場調査を実施し、得られた情報に基づいて製品開発方針を策定する。",
        "競合企業の製品を完全にコピーして市場に投入する。",
        "過去の実績に基づき、同じ製品を繰り返し販売する。",
        "消費者の意見を聞かずに、企業独自の判断で製品を開発する。",
      ],
      answerIndex: 0,
      explanation:
        "市場調査は顧客ニーズを把握し、製品開発・マーケティング戦略に反映させるための手法であり、企業競争力向上の基盤となる。",
    },
    {
      id: 34,
      category: "マネジメント",
      year: "令和5年10月",
      question:
        "ソフトウェア開発におけるテスト工程で、境界値テストを実施する目的として、最も適切なものはどれか。",
      choices: [
        "開発チーム全体の技能レベルを評価する。",
        "データ入力値が範囲の上限・下限付近で予期しない動作をしないか確認する。",
        "利用者の使いやすさに関する評価を行う。",
        "プロジェクトの総予算額を算出する。",
      ],
      answerIndex: 1,
      explanation:
        "境界値テストは、入力値が指定範囲の境界（最小値、最大値、その直前・直後）での動作をテストし、バグを検出する有効なテスト技法である。",
    },
    {
      id: 35,
      category: "テクノロジ",
      year: "令和3年4月",
      question:
        "ネットワークのセキュリティを確保する仕組みとして、複数の防御層を備えた設計アプローチを何というか。",
      choices: [
        "多層防御（ディフェンス・イン・デプス）",
        "シングルポイント・オブ・フェイルア",
        "スタティックルーティング",
      ...
      answerIndex: 0,
      explanation:
        "多層防御は、複数のセキュリティ対策を段階的に配置し、1つの防御層が破られても他の層が保護する体制を実現し、セキュリティ全体の堅牢性を高める方式である。",
    },
    {
      id: 36,
      category: "ストラテジ",
      year: "令和6年10月",
      question:
        "グローバル化する市場における企業の事業展開戦略として、最も適切なものはどれか。",
      choices: [
        "国内市場のみに集中し、海外進出は検討しない。",
        "各地域の文化・法律・消費者ニーズを理解し、地域に適応した製品・サービスを提供する。",
        "本社の方針を全世界で一律に適用する。",
        "国ごとに異なる価格設定は行わない。",
      ],
      answerIndex: 1,
      explanation:
        "グローバル化時代の競争力維持には、現地適応戦略（ローカライゼーション）による、地域ニーズに沿った製品開発・マーケティングが重要である。",
    },
    {
      id: 37,
      category: "マネジメント",
      year: "令和4年10月",
      question:
        "組織の意思決定プロセスにおいて、全員の意見を聞き取り、できるだけ全員が納得する決定を目指すアプローチを何というか。",
      choices: [
        "専断的意思決定",
        "民主的意思決定",
        "コンセンサス方式",
      ...
      answerIndex: 2,
      explanation:
        "コンセンサス方式は、関係者全体が議論を通じて合意に至ることで、組織内の信頼関係と実行力を高めるマネジメント手法である。",
    },
    {
      id: 38,
      category: "テクノロジ",
      year: "令和5年4月",
      question:
        "データベースの正規化を行う目的として、最も適切なものはどれか。",
      choices: [
        "データベースのサイズを必ず縮小する。",
        "データの冗長性を排除し、整合性と保守性を向上させる。",
        "すべてのテーブルを1つに統合する。",
        "クエリの実行速度を無制限に向上させる。",
      ],
      answerIndex: 1,
      explanation:
        "データベース正規化は、データの重複を排除し、更新異常を防ぎ、データ整合性を維持することで、効率的で保守性の高いデータベース設計を実現する。",
    },
    {
      id: 39,
      category: "テクノロジ",
      year: "令和3年10月",
      question:
        "オブジェクト指向プログラミングの概念として、部品の内部構造を隠蔽し、必要なインターフェースのみを公開する原則を何というか。",
      choices: [
        "カプセル化（エンカプセーション）",
        "ポリモーフィズム",
        "インヘリタンス",
      ...
      answerIndex: 0,
      explanation:
        "カプセル化は、オブジェクトの内部状態と操作を隠蔽し、必要なメソッド（インターフェース）のみを外部に公開することで、変更の影響範囲を限定し、保守性を向上させる。",
    },
  ];
