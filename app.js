...
(function () {
  ...
  const QUESTIONS = [
    ...
    },
    {
      ...
      choices: [
        "既存のIT環境をクラウドへ単純に移行するプロセス。",
        "デジタル技術を活用して、ビジネスモデルや企業文化を根本的に変革し、競争力を強化すること。",
        "単に新しいITツールを導入して業務効率を改善すること。",
        "紙ベースの書類をデジタル化するための取組み。",
      ],
      answerIndex: 1,
      explanation:
        "DXは単なるIT化ではなく、デジタル技術を活用してビジネスプロセスや組織全体を変革し、新しい価値を創出する戦略的な取組みである。",
    },
    {
      id: 43,
      category: "マネジメント",
      year: "令和3年4月",
      question:
        "プロジェクト管理における『アーン・バリュー・マネジメント（EVM）』で、プロジェクトの進捗状況を把握する際に用いられる指標はどれか。",
      choices: [
        "計画値（PV）と実績値（AV）のみ。",
        "計画値（PV）、出来高（EV）、実績費用（AC）。",
        "実績費用（AC）と機械稼働時間。",
        "プロジェクト予算と契約金額。",
      ],
      answerIndex: 1,
      explanation:
        "EVM（Earned Value Management）では、計画値（PV）・出来高（EV）・実績費用（AC）の3つを比較することで、コスト差異やスケジュール差異を定量的に把握できる。",
    },
    {
      id: 44,
      category: "テクノロジ",
      ...
      choices: [
        "インターネット上の仮想空間でのみ構築される情報システム。",
        "様々な物理デバイスがセンサーを搭載し、インターネットに接続されてデータを収集・交換する技術。",
        "情報システムのセキュリティを強化するための高度な認証技術。",
        "企業内のローカルエリアネットワークで相互接続される複数のサーバのこと。",
      ],
      answerIndex: 1,
      explanation:
        "IoTは、スマートフォンやセンサー搭載デバイスなど、様々な物がインターネットに接続されてデータを収集・共有する技術・概念である。",
    },
    {
      id: 45,
      category: "ストラテジ",
      year: "令和4年4月",
      question:
        "サプライチェーン全体の最適化を実現するための戦略として、最も適切なものはどれか。",
      choices: [
        "仕入先を1社に集約し、購買量を単純に増やす。",
        "各段階の在庫を最大化し、品切れを防ぐ。",
        "供給者・製造業者・流通業者・小売業者が情報を共有し、需要予測に基づいて効率的に連携する。",
        "国内流通のみに限定し、海外取引を避ける。",
      ],
      answerIndex: 2,
      explanation:
        "サプライチェーン最適化は、各段階での情報透明性と需要・供給の連携が重要であり、リードタイム短縮とコスト削減を実現する。",
    },
    {
      id: 46,
      category: "マネジメント",
      year: "令和5年4月",
      question:
        "ソフトウェア品質保証（QA）の目的として、最も適切なものはどれか。",
      choices: [
        "開発後のテストで見つかったバグを修正すること。",
        "開発プロセス全体を管理し、品質基準を満たすことを保証すること。",
        "開発コストを最小化し、納期内に完成させること。",
        "ユーザーからの問い合わせに対応する体制を整備すること。",
      ],
      answerIndex: 1,
      explanation:
        "QAは単なるテストではなく、設計・開発・テストの全段階でプロセスを管理し、品質基準を予防的に確保する取組みである。",
    },
    {
      id: 47,
      category: "テクノロジ",
      ...
      choices: [
        "中央の管理者による一元管理で、高速な取引を実現する。",
        "分散台帳として複数のノードに同一の記録を保持し、改ざんが困難である。",
        "企業内の限定ネットワークのみで動作し、外部接続はできない。",
        "リアルタイムで全データを一箇所に集約し、秘密保護性が高い。",
      ],
      answerIndex: 1,
      explanation:
        "ブロックチェーンは分散型台帳であり、複数のノードで同じ履歴を保有することで、透明性と改ざん防止を実現している。",
    },
    {
      id: 48,
      category: "ストラテジ",
      ...
      choices: [
        "業界内で最低価格を提供して市場シェアを拡大する。",
        "特定の市場セグメントに特化して、限定的なニーズに対応する。",
        "競合他社と異なる特徴・品質・機能を持つ製品またはサービスを提供する。",
        "大規模生産により、単位当たりコストを削減する。",
      ],
      answerIndex: 2,
      explanation:
        "差別化戦略は、独自性・高品質・革新性などで他社製品と差別化し、顧客の選好度を高める競争戦略である。",
    },
    {
      id: 49,
      category: "マネジメント",
      year: "令和5年10月",
      question:
        "IT ガバナンスの目的として、最も適切なものはどれか。",
      choices: [
        "情報システム部門の予算を最小化し、運用コストを削減する。",
        "IT投資の方針・意思決定プロセスを確立し、戦略と一貫性を保ちながらITリスクを管理する。",
        "最新のIT技術をいち早く導入し、競争優位性を確保する。",
        "経営層とIT部門の関係を明確に分離し、相互連携を避ける。",
      ],
      answerIndex: 1,
      explanation:
        "IT ガバナンスは、経営目標とIT戦略を一貫させ、IT投資・リスク・資源を統制し、持続的な価値創出を実現するための枠組みである。",
    },
    {
      id: 50,
      category: "テクノロジ",
      year: "令和4年4月",
      question:
        "REST（Representational State Transfer）APIの特徴として、最も適切なものはどれか。",
      choices: [
        "複雑な手順が必要で、習得に時間を要する標準仕様である。",
        "HTTPメソッド（GET・POST・PUT・DELETE）を活用し、ステートレスで拡張性の高い設計パターン。",
        "主にローカルネットワーク内でのみ使用可能なプロトコルである。",
        "常に大量のデータ転送が必要で、通信効率が低い仕様。",
      ],
      answerIndex: 1,
      explanation:
        "RESTは、HTTPの標準メソッドを活用したシンプルで拡張性の高いAPI設計パターンであり、Web上での相互運用性が高い。",
    },
  ];
