...
(function () {
  ...
  const QUESTIONS = [
    ...
    },
    {
      ...
      choices: [
        "既存システムを新しいハードウェアへ置き換えることで、性能を向上させる。",
        "デジタル技術を活用して、ビジネスプロセスや製品・サービスを抜本的に変革する。",
        "顧客データベースをクラウドへ移行し、コストを削減する。",
        "従業員がテレワークを実施するためのIT環境を整備する。",
      ],
      answerIndex: 1,
      explanation:
        "DXは単なるIT化ではなく、デジタル技術を活用した事業や組織の本質的な変革を指す。ビジネスモデルや顧客体験の革新を含む。",
    },
    {
      id: 58,
      category: "ストラテジ",
      year: "令和5年10月",
      question:
        "アウトソーシングの利点として、最も適切なものはどれか。",
      choices: [
        "自社の全ての経営資源を集中投下して、コアコンピタンスに注力できる。",
        "社外のベンダーに業務を委託することで、常に最新技術を得られる。",
        "委託先との契約によって、常に費用が固定化される。",
        "自社の従業員教育が不要になり、内部人材の養成が必要なくなる。",
      ],
      answerIndex: 0,
      explanation:
        "アウトソーシングにより、経営資源をコアビジネスに集中でき、効率性を高める。その一方で品質管理や情報セキュリティリスクの管理が課題となる。",
    },
    {
      id: 59,
      category: "ストラテジ",
      year: "令和4年10月",
      question:
        "ポジショニング戦略において、競争優位性を確立するために必要な要素として、最も適切なものはどれか。",
      choices: [
        "市場全体の規模を最大化する。",
        "競合他社との相違点を明確にし、顧客に認識させる。",
        "製品やサービスの価格を最低水準に設定する。",
        "全ての顧客セグメントに対して均等なマーケティング投資を行う。",
      ],
      answerIndex: 1,
      explanation:
        "ポジショニングは、ターゲット顧客の心の中で、競合他社と異なるユニークな位置付けを作ることである。差別化が競争優位性の源泉。",
    },
    {
      id: 60,
      category: "ストラテジ",
      year: "令和3年10月",
      question:
        "バリューチェーン分析の目的として、最も適切なものはどれか。",
      choices: [
        "営業部門の売上高と利益率を比較し、営業成績を評価する。",
        "製品開発から販売・アフターサービスまでの全プロセスを分析し、付加価値創造を最適化する。",
        "取引先との契約条件を見直し、単価交渉を有利に進める。",
        "全従業員のスキルレベルを診断し、職務配置の適性を判定する。",
      ],
      answerIndex: 1,
      explanation:
        "バリューチェーン分析は、企業活動全体を一連のプロセスとして把握し、どのプロセスで付加価値を創造しているか、またはコスト削減の余地があるかを分析する手法。",
    },
    {
      id: 61,
      category: "ストラテジ",
      year: "令和6年4月",
      question:
        "ビジネスモデルを構想する際に、顧客価値提案、収益源泉、主要リソースなどを体系的に整理するフレームワークを何というか。",
      choices: [
        "PEST分析",
        "ビジネスモデルキャンバス",
        "価値創造フレームワーク",
      ...
      answerIndex: 1,
      explanation:
        "ビジネスモデルキャンバスは、ビジネスの構成要素9つを一枚のシートで表現し、ビジネスモデル全体を可視化するツールである。",
    },
    {
      id: 62,
      category: "ストラテジ",
      year: "令和4年4月",
      question:
        "マーケティングにおける4P（マーケティングミックス）で、製品の価格戦略を決定する要素は次のどれか。",
      choices: [
        "Product",
        "Price",
        "Place",
      ...
      answerIndex: 1,
      explanation:
        "マーケティングミックスの4Pは、Product（製品）、Price（価格）、Place（流通）、Promotion（販促）である。価格戦略はPriceに該当する。",
    },
    {
      id: 63,
      category: "ストラテジ",
      ...
      question:
        "サプライチェーンマネジメント（SCM）の目的として、最も適切なものはどれか。",
      choices: [
        "取引先の経営内容を監督し、経営危機に瀕した企業を支援する。",
        "原材料調達から製造・流通・販売まで、全プロセスを統合して最適化し、顧客満足度とコスト効率を向上させる。",
        "在庫管理システムを導入して、倉庫内の人員を削減する。",
        "納期遅延のペナルティ条項を強化し、取引先の責任を明確化する。",
      ],
      answerIndex: 1,
      explanation:
        "SCMは、サプライチェーン全体を統合的に管理し、リードタイムの短縮・在庫最適化・品質向上を実現して、顧客価値と企業利益の両立を図る戦略である。",
    },
    {
      id: 64,
      category: "マネジメント",
      year: "令和5年10月",
      question:
        "リスク管理において、リスク評価の後に実施するべきプロセスとして、最も適切なものはどれか。",
      choices: [
        "リスク識別と記録",
        "リスク対応計画の立案と実行",
        "定期的なリスクの再評価",
      ...
      answerIndex: 1,
      explanation:
        "リスク管理プロセスは、リスク識別→評価→対応計画→実行→監視という流れが標準的である。リスク評価後は、具体的な対応策（回避・軽減・転嫁・受容）を計画・実行する。",
    },
    {
      id: 65,
      category: "マネジメント",
      year: "令和6年4月",
      question:
        "PDCAサイクルにおいて、Checkステップの目的として、最も適切なものはどれか。",
      choices: [
        "計画に基づいて、実際の業務を遂行する。",
        "計画との乖離を検出し、改善が必要な点を特定する。",
        "検出された課題に対して改善策を実行する。",
        "次期の経営戦略と目標を新たに立案する。",
      ],
      answerIndex: 1,
      explanation:
        "Check（チェック）ステップは、Plan で策定した目標や計画に対して、実際の実績・成果がどうであったかを検証し、乖離や問題点を明確化する段階である。",
    },
    {
      id: 66,
      category: "マネジメント",
      year: "令和4年10月",
      question:
        "プロジェクト・スケジュール管理において、タスク間の依存関係と所要期間を可視化するツールはどれか。",
      choices: [
        "WBS（Work Breakdown Structure）",
        "ガントチャート",
        "RACI マトリックス",
      ...
      answerIndex: 1,
      explanation:
        "ガントチャートは、横軸を時間、縦軸をタスクとして、各タスクの開始・終了時期と進捗状況を視覚的に表現するツール。プロジェクト全体の進捗管理に有効。",
    },
    {
      id: 67,
      category: "マネジメント",
      year: "令和5年4月",
      question:
        "変更管理（Change Management）の目的として、最も適切なものはどれか。",
      choices: [
        "業務改善のため、組織内のすべての仕事の進め方を一括で改める。",
        "システムや業務の変更を統制し、意図しない副作用や混乱を防ぐ。",
        "従業員の異動や配置転換を計画的に実施する。",
        "競合他社の戦略変化に対応するため、自社の経営方針を頻繁に変更する。",
      ],
      answerIndex: 1,
      explanation:
        "変更管理は、ITシステムやビジネスプロセスへの変更を統制し、影響範囲を評価し、計画的かつ安全に実施するためのプロセスである。",
    },
    {
      id: 68,
      category: "マネジメント",
      year: "令和3年10月",
      question:
        "コンフィグレーション管理の目的として、最も適切なものはどれか。",
      choices: [
        "顧客要件の変更に素早く対応し、最短納期での納品を実現する。",
        "ITシステムの構成要素（ハードウェア・ソフトウェア・ドキュメント）を一元管理し、正確な状態を把握・維持する。",
        "セキュリティ脅威を定期的に評価し、セキュリティ対策をアップデートする。",
        "プロジェクトメンバーのスキルレベルを一覧化し、最適な人員配置を計画する。",
      ],
      answerIndex: 1,
      explanation:
        "コンフィグレーション管理は、システムを構成するハード・ソフト・ドキュメント・設定値などを体系的に管理し、正確な構成情報を保持・共有することで、保守性と信頼性を向上させる。",
    },
    {
      id: 69,
      category: "マネジメント",
      year: "令和6年4月",
      question:
        "組織内で上司による評価だけでなく、部下・同僚・顧客など多角的な視点から人事評価を行う方法を何というか。",
      choices: [
        "目標管理評価（MBO）",
        "360度評価",
        "相対評価",
      ...
      answerIndex: 1,
      explanation:
        "360度評価は、被評価者の上司・部下・同僚・外部関係者など、複数の立場の人物から評価を集め、多角的・客観的に人事評価を行う手法である。",
    },
    {
      id: 70,
      category: "テクノロジ",
      year: "令和5年10月",
      question:
        "ネットワークセキュリティにおいて、特定のアドレスやポート、プロトコルのネットワークトラフィックを選別・遮断する装置を何というか。",
      choices: [
        "ルータ",
        "ファイアウォール",
        "ゲートウェイ",
      ...
      answerIndex: 1,
      explanation:
        "ファイアウォールは、社内ネットワークと外部ネットワークの境界に配置され、通信規則に基づいて通信を許可・拒否し、不正アクセスを防ぐセキュリティ機器である。",
    },
    {
      id: 71,
      category: "テクノロジ",
      year: "令和4年4月",
      question:
        "マルウェアの種類として、自己複製して他のファイルに寄生し、感染を広げるものはどれか。",
      choices: [
        "ワーム",
        "トロイの木馬",
        "ウイルス",
      ...
      answerIndex: 2,
      explanation:
        "ウイルスは、宿主となるプログラムに寄生し、自己複製機能を持つマルウェアである。対して、ワームは独立して動作し自己複製する。",
    },
    {
      id: 72,
      category: "テクノロジ",
      year: "令和5年4月",
      question:
        "クラウドコンピューティングの形態で、インフラストラクチャ（サーバ・ストレージ・ネットワーク）を提供する方式を何というか。",
      choices: [
      ...
      answerIndex: 2,
      explanation:
        "IaaSは、ハードウェアやネットワークなどのインフラストラクチャをクラウド上で提供し、ユーザがOS やアプリケーションをインストール・管理する方式である。",
    },
    {
      id: 73,
      category: "テクノロジ",
      year: "令和3年10月",
      question:
        "サーバ仮想化技術により、物理サーバ上で複数の独立した論理的なコンピュータを実行することを何というか。",
      choices: [
        "コンテナ化",
        "仮想マシン（VM）",
        "エミュレーション",
      ...
      answerIndex: 1,
      explanation:
        "仮想マシン（Virtual Machine）は、物理マシンの上で動作するソフトウェアベースの独立したコンピュータ環境であり、各々が独自のOSとアプリケーションを持つことができる。",
    },
    {
      id: 74,
      category: "テクノロジ",
      ...
      answerIndex: 3,
      explanation:
        "ビッグデータの3Vは、Volume（データ量の膨大さ）、Velocity（データ生成の高速性）、Variety（データ形式の多様性）である。Visibility は 3V には含まれない。",
    },
    {
      id: 75,
      category: "テクノロジ",
      year: "令和4年10月",
      question:
        "REST APIにおいて、HTTPメソッドを用いてリソースに対する操作を指定する際の設計原則として、最も適切なものはどれか。",
      choices: [
        "GET は常にデータ更新のために使用する。",
        "POST はリソースの取得専用に使用する。",
        "PUT はリソース全体の置換、PATCH は部分更新に用いる。",
        "DELETE は使用せず、論理削除のために PUT を使用する。",
      ],
      answerIndex: 2,
      explanation:
        "RESTful API の設計では、GET（取得）、POST（作成）、PUT（更新）、DELETE（削除）をHTTPメソッドとして使い分ける。PUTは全体置換、PATCH は部分更新が慣例。",
    },
    {
      id: 76,
      category: "テクノロジ",
      year: "令和5年4月",
      question:
        "SQLインジェクションは、入力フォームにSQLコードを混入させて実行させる攻撃手法である。対策として、最も効果的なものはどれか。",
      choices: [
        "ウェブサーバのログを毎日確認し、不正アクセス痕跡を検出する。",
        "ユーザからの入力値をチェックし、SQLのメタ文字を削除・エスケープ処理する。",
        "データベースのバックアップを毎日実施する。",
        "ファイアウォールを強化して、外部からのアクセスを制限する。",
      ],
      answerIndex: 1,
      explanation:
        "SQLインジェクション対策は、ユーザ入力に対して入力検証・サニタイゼーション・パラメータ化クエリを用いることが最も効果的である。特にプリペアドステートメントの使用が推奨される。",
    },
  ];
