...
(function () {
  ...
  const QUESTIONS = [
    ...
    },
    {
      ...
      year: "令和4年10月",
      question:
        "事業継続計画（BCP）の策定において最初に実施すべき活動として、最も適切なものはどれか。",
      choices: [
        "災害時の復旧手順マニュアルを作成する。",
        "重要な事業プロセスとそれを支える情報システムを識別する。",
        "従業員を対象とした災害対応訓練を実施する。",
        "事業継続計画の進捗状況を四半期ごとにレビューする。",
      ],
      answerIndex: 1,
      explanation:
        "BCP策定の初期段階は、自社にとって重要な事業プロセスと、それらを支えるシステム・リソースを把握することである。その後に優先順位を決定し、具体的な復旧計画や対応手順を策定する。",
    },
    {
      id: 31,
      category: "マネジメント",
      year: "令和5年4月",
      question:
        "プロジェクトの初期段階で、ステークホルダーの期待値と実現可能性の間に相違があった場合の対応として、最も適切なものはどれか。",
      choices: [
        "プロジェクトマネージャが単独で判断し、期待値に合わせて無理なスケジュールを組む。",
        "ステークホルダーとの協議により、期待値と実現可能性のギャップを認識し、合意形成を図る。",
        "期待値をそのまま受け入れ、後で調整することにする。",
        "ステークホルダーの要望を無視して、予定通り進める。",
      ],
      answerIndex: 1,
      explanation:
        "プロジェクト成功の鍵は、早期にステークホルダーとコミュニケーションを取り、期待値と制約条件を整理して共通理解を得ることである。",
    },
    {
      id: 32,
      category: "テクノロジ",
      year: "令和4年10月",
      question:
        "HTTPSがHTTPよりも優れている点として、最も適切なものはどれか。",
      choices: [
        "ページの読み込み速度が大幅に向上する。",
        "通信内容が暗号化され、盗聴やなりすまし攻撃から保護される。",
        "検索エンジンの結果順位が必ず上位に表示される。",
        "キャッシュ機能が不要になり、常に最新の情報が表示される。",
      ],
      answerIndex: 1,
      explanation:
        "HTTPSはTLS/SSLプロトコルを使用して通信を暗号化し、ウェブサーバの真正性を証明するデジタル証明書を用いることで、セキュアな通信を実現する。",
    },
    {
      id: 33,
      category: "ストラテジ",
      year: "令和3年4月",
      question:
        "情報セキュリティに関する国際標準である ISO 27001 の主な目的として、最も適切なものはどれか。",
      choices: [
        "企業のシステム開発プロセスを標準化する。",
        "個人情報保護方針を策定するためのガイドラインを提供する。",
        "情報セキュリティマネジメントシステム（ISMS）の構築・運用に関する要件を示す。",
        "Webアプリケーションの脆弱性を検出する方法を定める。",
      ],
      answerIndex: 2,
      explanation:
        "ISO 27001 は、情報セキュリティマネジメントシステム（ISMS）の要件を規定した国際規格であり、組織が情報資産を保護するための体系的なマネジメントを実施するための指針を提供する。",
    },
    {
      id: 34,
      category: "マネジメント",
      ...
      choices: [
        "テスト実行を通じて、プログラム内のバグをすべて発見する。",
        "開発プロセスの透明性を高め、ステークホルダーの満足度を向上させる。",
        "要件定義から本番運用まで、品質が適切に維持されているかを確保する体系的なアプローチ。",
        "納期を短縮し、開発コストを最小化する。",
      ],
      answerIndex: 2,
      explanation:
        "QAはテストに限定されず、開発プロセス全体を通じて品質を継続的に管理・改善し、顧客要件を満たすシステムを提供することを目指す。",
    },
    {
      id: 35,
      category: "テクノロジ",
      ...
      choices: [
        "訓練データの量を可能な限り増やす。",
        "モデルの複雑さを意図的に増加させ、パラメータ数を最大化する。",
        "訓練データとテストデータを分離し、定期的にテストデータで検証する。",
        "すべてのハイパーパラメータを固定値に設定する。",
      ],
      answerIndex: 2,
      explanation:
        "過学習を防ぐには、訓練用とテスト用のデータを厳密に分離し、モデルが未知のデータに対してどの程度の精度を持つかを継続的に検証することが重要である。",
    },
    {
      id: 36,
      category: "ストラテジ",
      year: "令和3年10月",
      question:
        "著作権法における保護対象として、最も適切なものはどれか。",
      choices: [
        "実用的な発明や技術改善すべて。",
        "創作性のある著作物（文学・音楽・絵画・プログラムなど）の表現。",
        "商品やサービスを識別するための記号やロゴ。",
        "医薬品や化学物質の具体的な成分構成。",
      ],
      answerIndex: 1,
      explanation:
        "著作権は、小説・楽曲・美術作品・コンピュータプログラムなど、創作性を持つ著作物の表現形式を保護する知的財産権である。",
    },
    {
      id: 37,
      category: "マネジメント",
      year: "令和5年10月",
      question:
        "組織のリスク管理プロセスにおいて、特定されたリスクへの対応戦略として、リスク低減が選択された場合の実施内容として、最も適切なものはどれか。",
      choices: [
        "そのリスクが発生しないように、該当するプロセスを完全に廃止する。",
        "リスクが発生した場合に備えて、保険に加入する。",
        "リスク発生確率や影響度を軽減するための施策を実施する。",
        "リスクの責任を第三者に委譲し、当組織では対応しない。",
      ],
      answerIndex: 2,
      explanation:
        "リスク低減戦略は、リスク対応の代表的な手法の一つで、セキュリティ対策の強化やプロセス改善など、リスク発生確率や影響度を削減するための具体的な施策を実施することである。",
    },
    {
      id: 38,
      category: "テクノロジ",
      year: "令和6年4月",
      question:
        "クラウドコンピューティングにおいて、サービス利用者がミドルウェアとアプリケーションの管理を行う一方、インフラストラクチャの管理はベンダが行うサービスモデルはどれか。",
      choices: [
      ...
      answerIndex: 1,
      explanation:
        "PaaS は、OS やミドルウェアなどの開発・実行環境をクラウドで提供し、利用者がアプリケーション開発・デプロイに集中できるサービスモデルである。インフラはベンダが管理する。",
    },
    {
      id: 39,
      category: "テクノロジ",
      year: "令和5年4月",
      question:
        "IoT（Internet of Things）技術の応用例として、最も適切なものはどれか。",
      choices: [
        "複数のコンピュータをローカルエリアネットワーク内で接続し、ファイル共有を行う。",
        "センサを備えた多数のデバイスがネットワークを通じて相互に通信し、リアルタイムでデータを収集・分析する。",
        "企業内の従業員に配布されるノートパソコンの遠隔管理を行う。",
        "スマートフォンアプリケーションを開発し、App Store で配布する。",
      ],
      answerIndex: 1,
      explanation:
        "IoT は、センサを装備した様々なデバイスがインターネットを通じてデータを交換し、リアルタイムな情報収集・分析・制御を実現する技術である。スマートシティやスマートファクトリーなど多くの応用例がある。",
    },
  ];
