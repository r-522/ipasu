...
(function () {
  ...
  const QUESTIONS = [
    ...
    },
    {
      ...
      year: "令和5年10月",
      question:
        "デジタル化に伴う新しい事業モデルの創造を目的とした経営戦略を何というか。",
      choices: [
        "デジタルトランスフォーメーション（DX）",
        "プロセスアウトソーシング",
        "クラウドマイグレーション",
      ...
      answerIndex: 0,
      explanation:
        "デジタルトランスフォーメーション（DX）は、情報技術を活用して事業プロセス・組織・文化・顧客体験を改革し、競争優位性を確保する経営戦略である。",
    },
    {
      id: 43,
      category: "マネジメント",
      ...
      question:
        "品質保証（QA）と品質管理（QC）の関係について、最も適切な説明はどれか。",
      choices: [
        "QAとQCは同じ意味の用語であり、区別の必要はない。",
        "QAは事前の予防活動、QCはプロセス中の検査・検証活動である。",
        "QCは企画段階、QAは運用段階の活動である。",
        "QAはISO認証、QCは社内ルールに基づく活動である。",
      ],
      answerIndex: 1,
      explanation:
        "QA（品質保証）は品質システムの構築・運用による事前予防、QC（品質管理）は実施中の検査・計測・修正による事後対応であり、両者は補完関係にある。",
    },
    {
      id: 44,
      category: "テクノロジ",
      year: "令和6年4月",
      question:
        "クラウドコンピューティングのSaaS（Software as a Service）の特徴として、最も適切なものはどれか。",
      choices: [
        "ユーザが自らサーバハードウェアを購入し、ソフトウェアをインストールして利用する。",
        "インターネット経由でベンダが提供するアプリケーションを、ライセンス料を支払って利用する。",
        "ユーザが独自のアプリケーションを開発・実行するためのプラットフォームを提供する。",
        "企業内ネットワークのみで利用可能な、オンプレミス型のソフトウェアサービスである。",
      ],
      answerIndex: 1,
      explanation:
        "SaaS（Software as a Service）は、ベンダがクラウド上でアプリケーションを運用し、ユーザがネットワーク経由でサブスクリプション方式で利用するクラウドサービスの形態である。",
    },
    {
      id: 45,
      category: "ストラテジ",
      year: "令和3年10月",
      question:
        "知的財産権のうち、発明や創作物に対する独占的な権利を保護する制度を指す最も適切な用語はどれか。",
      choices: [
        "著作権",
        "商標権",
        "特許権",
      ...
      answerIndex: 2,
      explanation:
        "特許権は新しい発明に対して与えられる排他的権利であり、特許庁の審査を経て認められた技術的発明を一定期間保護する知的財産権である。",
    },
    {
      id: 46,
      category: "マネジメント",
      year: "令和5年4月",
      question:
        "ソフトウェア開発において、顧客の要件を定め、開発プロセスを計画する段階を何というか。",
      choices: [
        "詳細設計",
        "要件定義",
        "実装",
      ...
      answerIndex: 1,
      explanation:
        "要件定義は、顧客のニーズや課題を理解し、システムが何をどの程度までで実現すべきかを明確にする最も重要な開発段階である。",
    },
    {
      id: 47,
      category: "テクノロジ",
      ...
      choices: [
        "ユーザがログインしたセッション中に、意図しない操作をさせられる攻撃。",
        "Webアプリケーションに不正なスクリプトを埋め込み、他のユーザのブラウザで実行させる脆弱性。",
        "ネットワーク通信を盗聴し、通信中のデータを改ざんする攻撃。",
        "大量のアクセスを送信してサーバを過負荷にする分散型攻撃。",
      ],
      answerIndex: 1,
      explanation:
        "XSS（Cross-Site Scripting）は、Webサイトの入力フィールドなどに悪意あるスクリプトを注入し、閲覧ユーザのブラウザで実行させる脆弱性である。入力値の適切なエスケープで防止される。",
    },
    {
      id: 48,
      category: "ストラテジ",
      year: "令和6年10月",
      question:
        "企業が社会的責任を果たし、持続可能な成長を目指すための経営理念を何というか。",
      choices: [
        "コンプライアンス",
        "ガバナンス",
        "サステナビリティ",
      ...
      answerIndex: 2,
      explanation:
        "サステナビリティ（持続可能性）は、経済成長と環境保全・社会貢献の均衡を取り、長期的に企業価値を維持するための経営方針である。",
    },
    {
      id: 49,
      category: "マネジメント",
      year: "令和4年10月",
      question:
        "プロジェクトの進捗管理において、実績の進捗度合いから計画との乖離を検出する手法として、最も適切なものはどれか。",
      choices: [
        "ファンクションポイント法",
        "ガントチャート",
        "PERT分析",
      ...
      answerIndex: 3,
      explanation:
        "バーンダウンチャートは、残りの作業量を縦軸、経過時間を横軸として表示し、計画線との比較で進捗の遅れや加速を視覚的に管理する手法である。",
    },
    {
      id: 50,
      category: "テクノロジ",
      ...
      choices: [
        "中央のサーバで全てのデータを集約管理し、高速な処理を実現する。",
        "複数のノードで分散的にデータを保有し、改ざんが極めて困難な構造である。",
        "暗号化されたデータはマスターキーでのみ復号可能であり、階層的な権限管理が可能である。",
        "トランザクション速度は遅いが、無制限のスケーラビリティを実現する。",
      ],
      answerIndex: 1,
      explanation:
        "ブロックチェーンは、複数のノードがデータを分散管理し、過去のトランザクション記録を鎖状に連結しているため、改ざんが難しく透明性が高い技術である。",
    },
    {
      id: 51,
      category: "ストラテジ",
      year: "令和3年4月",
      question:
        "企業会計における固定費と変動費の特徴として、最も適切な説明はどれか。",
      choices: [
        "固定費は生産量に応じて変化し、変動費は生産量にかかわらず一定である。",
        "固定費は生産量にかかわらず一定であり、変動費は生産量に応じて変化する。",
        "固定費と変動費に区別はなく、企業の判断で分類する。",
        "固定費は営業費用、変動費は研究開発費である。",
      ],
      answerIndex: 1,
      explanation:
        "固定費は売上や生産量に関係なく発生する費用（家賃・人件費など）、変動費は生産量に比例して増減する費用（原材料費・製造工程費など）である。",
    },
    {
      id: 52,
      category: "マネジメント",
      ...
      answerIndex: 0,
      explanation:
        "情報セキュリティの三要素（CIA）は、機密性（Confidentiality：権限のない者の閲覧を防止）、完全性（Integrity：データの正確性を保証）、可用性（Availability：必要な時に利用可能）である。",
    },
    {
      id: 53,
      category: "テクノロジ",
      year: "令和5年4月",
      question:
        "IoT（Internet of Things）デバイスの特徴として、最も適切なものはどれか。",
      choices: [
        "人間の操作がない場合、自動的に電源が切れる省電力設計である。",
        "物理的なセンサやデバイスがインターネットに接続され、データ収集や遠隔制御を行う。",
        "個人用コンピュータと同等の処理能力を備え、独立したOSで動作する。",
        "クラウドストレージとのみ連携可能であり、従来のネットワークには接続できない。",
      ],
      answerIndex: 1,
      explanation:
        "IoTは、センサやカメラなど様々な物理デバイスをインターネットで相互接続し、リアルタイムでデータを収集・分析・制御する技術である。",
    },
  ];
