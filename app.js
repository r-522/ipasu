...
(function () {
  ...
  const QUESTIONS = [
    ...
    },
    {
      ...
      year: "令和4年10月",
      question:
        "クラウドコンピューティングの導入によって企業が期待できるメリットとして、最も適切なものはどれか。",
      choices: [
        "初期投資が大幅に削減でき、従量課金モデルでIT資産を運用できる。",
        "データセンターの物理的な移転が不要になり、立地リスクが完全に解消される。",
        "すべてのセキュリティ対策が自動的に実装されるため、自社での対策が不要になる。",
        "通信速度が光ファイバーより5倍以上高速になるため、処理が極めて高速化される。",
      ],
      answerIndex: 0,
      explanation:
        "クラウドコンピューティングは初期設備投資を削減し、必要なリソースを従量課金で利用でき、柔軟な事業展開を可能にする。セキュリティやリスク対策は依然として自社の責任である。",
    },
    {
      id: 31,
      category: "マネジメント",
      year: "令和5年4月",
      question:
        "情報システムのセキュリティ侵害が発生した場合の対応プロセスにおいて、検知直後に最初に実施すべき活動はどれか。",
      choices: [
        "原因を特定し、全世界のメディアに速報として発表する。",
        "直ちに該当システムを停止し、被害を最小限に抑える初期対応を実施する。",
        "3ヶ月かけて詳細な根本原因分析を行い、最適な対策を検討する。",
        "経営層の承認を得るまで全ての対応を保留し、判断を待つ。",
      ],
      answerIndex: 1,
      explanation:
        "セキュリティ侵害への初期対応は、被害の拡大を防ぐために素早い隔離と対応が重要である。検知から一定時間内に初期対応を完了するプロセス設計が不可欠である。",
    },
    {
      id: 32,
      category: "テクノロジ",
      ...
      choices: [
        "中央管理者によって一元的に台帳が管理され、改ざん検知が容易である。",
        "分散台帳として複数のノードで同じデータを保有し、改ざんに強い仕組みを持つ。",
        "リレーショナルデータベースよりも検索速度が常に高速である。",
        "個人間の送金に限定され、企業レベルのシステムには適用できない。",
      ],
      answerIndex: 1,
      explanation:
        "ブロックチェーンは分散型の台帳技術で、複数ノードでの冗長管理と暗号学的検証により、改ざんへの耐性が高い点が特徴である。",
    },
    {
      id: 33,
      category: "ストラテジ",
      year: "令和6年4月",
      question:
        "ビジネスプロセスの改善（BPI）を推進する際の重要な第一歩として、最も適切なものはどれか。",
      choices: [
        "高額なシステムベンダーを選定し、最新技術の導入を急ぐ。",
        "現状のプロセスを可視化・分析し、問題点と改善機会を特定する。",
        "経営層から承認なしに、現場の判断で全面的なリストラを実施する。",
        "定性的な推測に基づいて新プロセスを設計し、即座に本番導入する。",
      ],
      answerIndex: 1,
      explanation:
        "BPIの成功には、改善前の現状プロセスの可視化と分析が不可欠である。データに基づく問題点の把握が、効果的な改善につながる。",
    },
    {
      id: 34,
      category: "マネジメント",
      year: "令和5年10月",
      question:
        "プロジェクトマネジメントにおけるスコープ管理の目的として、最も適切なものはどれか。",
      choices: [
        "プロジェクトの予算の最小化のみを目指す。",
        "プロジェクトが実施する作業の範囲を明確にし、スコープクリープを防止する。",
        "プロジェクトメンバーの個人目標を最優先にする。",
        "顧客の要望を無視し、技術者の自由裁量に任せる。",
      ],
      answerIndex: 1,
      explanation:
        "スコープ管理は、プロジェクトの成果物と作業範囲を明確に定義し、承認されていない追加要求（スコープクリープ）を防ぎ、プロジェクトの成功を確保する。",
    },
    {
      id: 35,
      category: "テクノロジ",
      year: "令和4年4月",
      question:
        "AIと機械学習の関係として、最も適切なものはどれか。",
      choices: [
        "機械学習とAIは全く異なる分野であり、関連性はない。",
        "機械学習はAIの実現手法の一つであり、AIがより広い概念である。",
        "AIは機械学習に内包される技術であり、機械学習の方が上位概念である。",
        "機械学習は人間の指示のみで動作し、学習機能を持たない。",
      ],
      answerIndex: 1,
      explanation:
        "AIは「知的な判断や意思決定を行う技術」の総称であり、機械学習はデータから自動的にパターンを学ぶAI実現手法の一つである。",
    },
    {
      id: 36,
      category: "ストラテジ",
      year: "令和5年4月",
      question:
        "デジタルトランスフォーメーション（DX）の目的として、最も適切なものはどれか。",
      choices: [
        "紙のドキュメントをすべてデジタル化することだけである。",
        "レガシーシステムを単に新しい技術に置き換えることである。",
        "デジタル技術を活用して、ビジネスモデルや企業文化まで含めた根本的な変革を実現することである。",
        "IT部門だけがデジタル技術を導入し、他部門の関与は不要である。",
      ],
      answerIndex: 2,
      explanation:
        "DXはデジタル技術の導入に止まらず、ビジネスプロセス、企業文化、組織構造を含めた包括的な改革であり、競争力強化と新たな価値創造を目指すものである。",
    },
    {
      id: 37,
      category: "マネジメント",
      year: "令和6年10月",
      question:
        "組織における情報セキュリティ文化を醸成するための施策として、最も適切なものはどれか。",
      choices: [
        "セキュリティポリシーを策定した後は、従業員教育は実施しなくてよい。",
        "定期的な教育訓練、セキュリティインシデント演習、管理者による監視体制の構築を組み合わせる。",
        "セキュリティは技術部門のみの責任であり、一般従業員の行動変容は期待できない。",
        "サイバー攻撃が発生してから対応を開始すればよい。",
      ],
      answerIndex: 1,
      explanation:
        "情報セキュリティ文化の醸成には、継続的な従業員教育、シミュレーション訓練、適切なガバナンス体制が必要である。組織全体での意識向上が重要である。",
    },
    {
      id: 38,
      category: "テクノロジ",
      ...
      choices: [
        "開発環境と本番環境でアプリケーションが異なる動作をしても問題ない。",
        "アプリケーション、ライブラリ、依存関係を含めた環境全体を軽量なコンテナとしてパッケージ化でき、異なる環境での一貫性が保証される。",
        "仮想マシンと比べてセキュリティが必ず高くなる。",
        "OSレベルのカスタマイズが無制限に可能になり、コストが削減される。",
      ],
      answerIndex: 1,
      explanation:
        "コンテナ技術は、アプリケーション実行に必要なすべての要素をパッケージ化し、開発環境から本番環境への一貫性を実現する。仮想マシンより軽量で迅速なデプロイを可能にする。",
    },
  ];
